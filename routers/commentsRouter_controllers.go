...
func init() {
    ...
    beego.GlobalControllerRouter["envelop/controllers:EnvelopController"] = append(beego.GlobalControllerRouter["envelop/controllers:EnvelopController"],
        beego.ControllerComments{
            Method: "Create",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
